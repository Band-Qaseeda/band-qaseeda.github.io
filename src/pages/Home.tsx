  ...
  <>
       ...
       <div className="py-[3rem] lg:py-0 relative flex flex-col justify-center text-center w-full h-full">
        <div>
         <div className="relative z-10 flex flex-col items-center">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold max-w-3xl drop-shadow">
          ...
          <p className="text-sm sm:text-md md:text-lg lg:text-xl mt-4 md:mt-8 text-gray-300 max-w-3xl">
           Where tradition meets youthful spirit. We fuse Bangladesh's nearly
           lost cultural heritage with modern music, preserving its essence
           while crafting something soulful and groundbreaking.
          </p>
          <Link to="/about-us">
           <Button
            className="mt-8"
   ...
   <div className="w-full bg-grayish py-4">
    <div className="my-8 w-full max-w-7xl mx-auto p-8">
     <div className="w-full h-full flex justify-between items-center gap-4 md:gap-8">
      <div>
       <h1 className="text-3xl md:text-4xl lg:text-5xl  font-semibold drop-shadow">
        Who are we?
       </h1>
   ...
   <div className="w-full max-w-7xl mx-auto p-8 pt-0">
    <div className="mt-16 md:mt-0">
     <h1 className="text-center text-3xl sm:text-4xl md:text-5xl  font-semibold drop-shadow mt-12 md:mt-[100px] mb-8">
      Discography
     </h1>
     <div className="relative my-8 w-full rounded-[1.375rem] lg:rounded-[2.375rem] bg-cover bg-[url('/images/4557126.jpg')] bg-center">
      <div
       ...
       id="discography-main"
      >
       <div className="flex gap-5 overflow-x-auto" id="discography-slider">
        {discographyLists
         ...
         .map((d, i) => (
          <div
           ...
           key={i}
          >
           <iframe src={d.video} className="w-full h-[350px]"></iframe>
           <div className="p-4">
     ...
     <div className="my-8 w-full py-8 lg:py-12">
      <h1 className="text-center text-2xl sm:text-3xl md:text-4xl lg:text-5xl  font-semibold drop-shadow mb-8">
       Upcoming Events
      </h1>
      <Slider
       infinite={false}
        ...
        events
         ...
         .map((e, i) => (
          <div className="w-full p-4 lg:p-8 relative" key={i}>
           ...
           >
            <p className="text-sm md:text-md flex gap-2 items-center justify-center font-semibold">
             <svg
              id="dot"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 20 20"
