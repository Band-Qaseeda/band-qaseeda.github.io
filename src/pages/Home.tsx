...
export default function Home() {
 const events = eventsList.filter((e) => new Date(Date.parse(e.date)) >= new Date());
 useEffect(() => {
  discographySlider();
 }, []);
 ...
 return (
  <>
   ...
   <div className="w-full max-w-7xl mx-auto">
    <div className="md:h-[90vh] bg-gradient-to-b from-transparent to-primary/30 flex items-center justify-center relative">
     <img
      src="/icons/mic.png"
      alt="Qawwali"
      className="absolute inset-0 w-90 h-full object-cover"
     />
     <div className="py-[4rem] md:py-0 relative flex flex-col justify-center text-center w-full h-full bg-neutral/50">
      <div>
       <div className="relative z-10 flex flex-col items-center px-4">
        ...
        <p className="text-sm sm:text-md md:text-lg lg:text-xl mt-4 md:mt-8 opacity-75 max-w-xl">
         Discover a journey through the profound rhythms and melodies of Qawwali
         and Najrul Geeti.
        </p>
    ...
    <div className="mb-8  w-full bg-primary/40">
     <div className="w-full h-full bg-neutral/70 flex justify-between items-center">
     ...
     <div className="w-full h-full bg-neutral/60 flex justify-between items-center">
      <div className="hidden md:block">
       <img
